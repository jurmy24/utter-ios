...
struct TestVoiceTranscriptionView: View {
    @StateObject private var viewModel: TestVoiceTranscriptionViewModel
    ...
    init(targetText: String) {
        self._viewModel = StateObject(wrappedValue: TestVoiceTranscriptionViewModel(targetText: targetText))
    }
